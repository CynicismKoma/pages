...
pubDatetime: 2022-06-30T09:33:36
description: "一、Transformations 分类 Flink 的 Transformations 操作主要用于将一个和多个 DataStream 按需转换成新的 DataStream。它主要分为以下三类： DataStream Transformations ：进行数据流相关转换操作； Physical partitioning ：物理分区。Flink 提供的底层 API ，允许用户定义数据的分区规则； "
tags: []
draft: false
---
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/08de3301c454006958ad7fb9056496cf.png#pic_center)
