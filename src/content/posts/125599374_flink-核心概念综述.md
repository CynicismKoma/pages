---
title: "Flink 核心概念综述"
pubDatetime: 2022-07-04T14:27:16.000Z
description: "文章浏览阅读513次。Flink 核心概念综述_flink actor system"
tags: []
draft: false
---
### 一、Flink 简介
...
![在这里插入图片描述](/assets/125599374_0.png#pic_center)

Spark Streaming 数据流的拆分：

![在这里插入图片描述](/assets/125599374_1.png#pic_center)

### 二、Flink 核心架构

Flink 采用分层的架构设计，从而保证各层在功能和职责上的清晰。如下图所示，由上而下分别是 API & Libraries 层、Runtime 核心层以及物理部署层：

![在这里插入图片描述](/assets/125599374_2.png#pic_center)
...
![在这里插入图片描述](/assets/125599374_3.png#pic_center)
...
![在这里插入图片描述](/assets/125599374_4.png#pic_center)
...
![在这里插入图片描述](/assets/125599374_5.png#pic_center)
...
![在这里插入图片描述](/assets/125599374_6.png#pic_center)

这时每个 SubTask 线程运行在一个独立的 TaskSlot， 它们共享所属的 TaskManager 进程的TCP 连接（通过多路复用技术）和心跳信息 (heartbeat messages)，从而可以降低整体的性能开销。此时看似是最好的情况，但是每个操作需要的资源都是不尽相同的，这里假设该作业 keyBy 操作所需资源的数量比 Sink 多很多 ，那么此时 Sink 所在 Slot 的资源就没有得到有效的利用。

基于这个原因，Flink 允许多个 subtasks 共享 slots，即使它们是不同 tasks 的 subtasks，但只要它们来自同一个 Job 就可以。假设上面 souce & map 和 keyBy 的并行度调整为 6，而 Slot 的数量不变，此时情况如下：

![在这里插入图片描述](/assets/125599374_7.png#pic_center)
...
![在这里插入图片描述](/assets/125599374_8.png#pic_center)
...
![在这里插入图片描述](/assets/125599374_9.png#pic_center)
