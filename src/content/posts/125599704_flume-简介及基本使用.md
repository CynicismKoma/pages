---
title: "Flume 简介及基本使用"
pubDatetime: 2022-07-04T14:42:24
description: "一、Flume简介 Apache Flume 是一个分布式，高可用的数据收集系统。它可以从不同的数据源收集数据，经过聚合后发送到存储系统中，通常用于日志数据的收集。Flume 分为 NG 和 OG (1.0 之前) 两个版本，NG 在 OG 的基础上进行了完全的重构，是目前使用最为广泛的版本。下面的介绍均以 NG 为基础。 二、Flume架构和基本概念 下图为 Flume 的基本架构图： 2.1 "
tags: []
draft: false
---
### 一、Flume简介
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4b8add3ecf86ca685f34b97866ca4aeb.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/76859a796d701288f77a473aafb11fca.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8d081f3b184b8da70ffc73f4444efcdd.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a94591b771649f04ab0ae5c846855073.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/41c8b8df6f826bc373c1a7b9040ea78c.png#pic_center)

控制台的显示：

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/67a381f30d56f2733fc3e91bdf69c17c.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ddb9255c1e6e773ff316038f13eeb561.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8fffb6eaaf3b09a2cf6e95cf9720b6ed.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/170dedf08785900a2535ab13b108533f.png#pic_center)

##### 4.测试

向文件 `tmp/log.txt` 中追加内容：

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f717aded83a24dc6e9ef7f70b024806a.png#pic_center)

可以看到已经从 8888 端口监听到内容，并成功输出到控制台：

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/e655bae0a757cca3a9fbbf775bfcf796.png#pic_center)