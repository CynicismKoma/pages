...
pubDatetime: 2022-07-04T14:59:57.000Z
description: "文章浏览阅读2.6k次。本文介绍了Hadoop MapReduce的基本概念及其编程模型，并通过词频统计案例详细展示了如何使用MapReduce进行大规模数据处理，包括Combiner和Partitioner的使用。"
tags: []
draft: false
---
...
![在这里插入图片描述](/assets/125600247_0.png)
...
![在这里插入图片描述](/assets/125600247_1.png)
...
![在这里插入图片描述](/assets/125600247_2.png)

使用 combiner 的情况：

![在这里插入图片描述](/assets/125600247_3.png)
...
![在这里插入图片描述](/assets/125600247_4.png)
...
![在这里插入图片描述](/assets/125600247_5.png)
...
![在这里插入图片描述](/assets/125600247_6.png)
...
![在这里插入图片描述](/assets/125600247_7.png)

加入 `combiner` 后的打印日志如下：

![在这里插入图片描述](/assets/125600247_8.png)
...
![在这里插入图片描述](/assets/125600247_9.png)
