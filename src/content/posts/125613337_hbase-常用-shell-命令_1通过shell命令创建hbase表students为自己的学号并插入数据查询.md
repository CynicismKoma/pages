---
title: "Hbase 常用 Shell 命令_1.通过shell命令创建hbase表students***(***为自己的学号),并插入数据、查询"
pubDatetime: 2022-07-05T09:37:08
description: "一、基本命令 打开 Hbase Shell： # hbase shell AI写代码 shell 1 1.1 获取帮助 # 获取帮助 help # 获取命令的详细信息 help 'status' AI写代码 shell 1 2 3 4 1.2 查看服务器状态 status AI写代码 shell 1 1.3 查看版本信息 version AI写代码 shell 1 二、关于表的操作 2.1 查看所"
tags: []
draft: false
---
### 一、基本命令
