---
title: "HBase过滤器详解"
pubDatetime: 2022-07-05T10:06:36
description: "一、HBase过滤器简介 Hbase 提供了种类丰富的过滤器（filter）来提高数据处理的效率，用户可以通过内置或自定义的过滤器来对数据进行过滤，所有的过滤器都在服务端生效，即谓词下推（predicate push down）。这样可以保证过滤掉的数据不会被传送到客户端，从而减轻网络传输和客户端处理的压力。 二、过滤器基础 2.1  Filter接口和FilterBase抽象类 Filter 接"
tags: []
draft: false
---
### 一、HBase过滤器简介
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/a9d7c43def7329752faddb0e2e1efb57.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/507d618af14e633dd870c33f9ecd3b3b.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/047250894be96b0fce6cc7d8ccc7d7c0.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/86a2149d908592f6e7f875ab230160c6.png#pic_center)
