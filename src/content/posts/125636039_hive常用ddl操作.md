---
title: "Hive常用DDL操作"
pubDatetime: 2022-07-06T11:18:47.000Z
description: "文章浏览阅读362次。本文围绕Hive数据库展开，详细介绍了数据库的查看、使用、新建、信息查看和删除操作。还阐述了多种表的创建，如内部表、外部表等，以及表的修改、清空和删除方法。此外，对Describe和Show等其他命令的使用也做了说明。"
tags: []
draft: false
---
### 一、Database
...
![在这里插入图片描述](/assets/125636039_0.png#pic_center)
...
![在这里插入图片描述](/assets/125636039_1.png#pic_center)
...
![在这里插入图片描述](/assets/125636039_2.png#pic_center)
