---
title: "Hive数据操作与查询优化详解"
pubDatetime: 2022-07-11T10:48:31
description: "一、数据准备 为了演示查询操作，这里需要预先创建三张表，并加载测试数据。 1.1 员工表 -- 建表语句 CREATE TABLE emp ( empno INT , -- 员工表编号 ename STRING , -- 员工姓名 job STRING , -- 职位类型 mgr INT , hiredate TIMESTAMP , --雇佣日期 sal DECIMAL ( 7 , 2 ) , -"
tags: []
draft: false
---
### 一、数据准备
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7d367c115bcbfcbc481975a193e201bf.jpeg#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/747a10cdd7394d4c461db99bb6f9c775.png#pic_center)
