---
title: "Hive数据仓库：SQL查询、元数据管理与存储格式解析"
pubDatetime: 2022-07-11T10:50:52
description: "一、简介 Hive 是一个构建在 Hadoop 之上的数据仓库，它可以将结构化的数据文件映射成表，并提供类 SQL 查询功能，用于查询的 SQL 语句会被转化为 MapReduce 作业，然后提交到 Hadoop 上运行。 特点 ： 简单、容易上手 (提供了类似 sql 的查询语言 hql)，使得精通 sql 但是不了解 Java 编程的人也能很好地进行大数据分析； 灵活性高，可以自定义用户函数 "
tags: []
draft: false
---
### 一、简介
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/1a8994e8bb02a99460bd0589fa8e05d8.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/ffbed4e105e622d9919797a0e503b991.png#pic_center)
