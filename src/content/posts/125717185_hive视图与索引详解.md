---
title: "Hive视图与索引详解"
pubDatetime: 2022-07-11T10:53:42
description: "一、视图 1.1 简介 Hive 中的视图和 RDBMS 中视图的概念一致，都是一组数据的逻辑表示，本质上就是一条 SELECT 语句的结果集。视图是纯粹的逻辑对象，没有关联的存储 (Hive 3.0.0 引入的物化视图除外)，当查询引用视图时，Hive 可以将视图的定义与查询结合起来，例如将查询中的过滤器推送到视图中。 1.2 创建视图 CREATE VIEW [ IF NOT EXISTS ]"
tags: []
draft: false
---
### 一、视图  
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/647bdecebb77cd08486175ae33a71b23.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/e83b1c77b4499fd0024e8c0ef3da3799.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/5b0e9ca94d4510ec182b17f475c09e60.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2250bfa7f18a86decf61de46cb292b57.png#pic_center)
