---
title: "函数和闭包"
pubDatetime: 2022-07-11T11:14:43.000Z
description: "文章浏览阅读199次。本文深入解析Scala中的函数概念，包括函数与方法的区别、一等公民特性、匿名函数、可变参数、闭包的定义与修改、高阶函数的应用及函数柯里化。实例演示了如何利用这些特性进行编程和参数传递。"
tags: []
draft: false
---
