---
title: "Scala List & Set_scala 字符串转list"
pubDatetime: 2022-07-11T11:15:59
description: "一、List字面量 List 是 Scala 中非常重要的一个数据结构，其与 Array(数组) 非常类似，但是 List 是不可变的，和 Java 中的 List 一样，其底层实现是链表。 scala > val list = List ( 'hadoop' , 'spark' , 'storm' ) list : List [ String ] = List ( hadoop , spark "
tags: []
draft: false
---
### 一、List字面量
