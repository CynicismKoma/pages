---
title: "Scala Map & Tuple"
pubDatetime: 2022-07-12T14:11:15.000Z
description: "文章浏览阅读330次。本文详细介绍了Scala中的Map操作，包括初始化、获取值、新增/修改/删除值、遍历以及不同类型的Map。同时，还探讨了元组的使用，如模式匹配和zip方法，展示了如何在元组和数组之间转换。"
tags: []
draft: false
---
### 一、映射(Map)
