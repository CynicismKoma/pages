---
title: "Scala 类和对象"
pubDatetime: 2022-07-12T14:39:48.000Z
description: "文章浏览阅读519次。本文详细介绍了Scala中的类和对象，包括成员变量的可见性、getter和setter、主构造器和辅助构造器的使用，以及对象的单例模式和伴生对象。示例代码展示了如何声明和操作变量，以及如何实现枚举。此外，还讨论了方法参数的不可变性。"
tags: []
draft: false
---
### 一、初识类和对象
