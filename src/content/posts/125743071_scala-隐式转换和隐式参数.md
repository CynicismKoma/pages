...
pubDatetime: 2022-07-14T09:35:55.000Z
description: "文章浏览阅读340次。本文详细介绍了Scala编程语言中的隐式转换和隐式参数概念。通过实例展示了如何使用`implicit`关键字定义转换函数，使得类型之间能够进行功能扩展，并探讨了隐式转换的规则和应用场景。此外，还讲解了隐式参数的使用，包括默认值的设定、避免二义性和导入方式。最后，文章提到了隐式参数在泛型方法中的应用，如解决类型比较的问题。"
tags: []
draft: false
---
### 一、隐式转换
...
![在这里插入图片描述](/assets/125743071_0.png#pic_center)
