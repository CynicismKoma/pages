---
title: "Scala 集合"
pubDatetime: 2022-07-14T09:49:13.000Z
description: "文章浏览阅读404次。本文深入探讨Scala中的集合类型，包括可变与不可变集合的区别，以及scala.collection、scala.collection.immutable和scala.collection.mutable包中的集合结构。重点介绍了Traversable特质，详述其提供的各种操作方法，并通过实例展示了如何使用。此外，还解析了Iterable特质及其特有的方法。文章最后讨论了如何"
tags: []
draft: false
---
### 一、集合简介
...
![在这里插入图片描述](/assets/125777592_0.png#pic_center)

#### 3.2 scala.collection.mutable

scala.collection.mutable 包中所有集合如下图：

![在这里插入图片描述](/assets/125777592_1.png#pic_center)

#### 3.2 scala.collection.immutable

scala.collection.immutable 包中所有集合如下图：

![在这里插入图片描述](/assets/125777592_2.png#pic_center)
...
---|---|---  
coll(k)  
即 coll.apply(k)| 获取指定位置的元素| Seq, Map  
coll :+ elem  
