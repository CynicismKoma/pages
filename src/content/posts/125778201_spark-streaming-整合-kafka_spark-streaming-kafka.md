---
title: "Spark Streaming 整合 Kafka_spark streaming + kafka"
pubDatetime: 2022-07-14T10:00:11
description: "一、版本说明 Spark 针对 Kafka 的不同版本，提供了两套整合方案： spark-streaming-kafka-0-8 和 spark-streaming-kafka-0-10 ，其主要区别如下： spark-streaming-kafka-0-8 spark-streaming-kafka-0-10 Kafka 版本 0.8.2.1 or higher 0.10.0 or higher"
tags: []
draft: false
---
### 一、版本说明
...
AP 状态| Deprecated  
从 Spark 2.3.0 版本开始，Kafka 0.8 支持已被弃用| Stable(稳定版)  
