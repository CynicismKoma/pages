---
title: "Spark Structured API基本使用_spark implicits"
pubDatetime: 2022-07-14T10:02:02
description: "一、创建DataFrame和Dataset 1.1 创建DataFrame Spark 中所有功能的入口点是 SparkSession ，可以使用 SparkSession.builder() 创建。创建后应用程序就可以从现有 RDD，Hive 表或 Spark 数据源创建 DataFrame。示例如下： val spark = SparkSession . builder ( ) . appNa"
tags: []
draft: false
---
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/bc7d3525158a9d228a775a994160ed72.png#pic_center)
