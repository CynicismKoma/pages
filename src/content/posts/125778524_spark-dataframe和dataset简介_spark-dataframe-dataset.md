---
title: "Spark DataFrame和Dataset简介_spark dataframe dataset"
pubDatetime: 2022-07-14T10:11:37
description: "一、Spark SQL简介 Spark SQL 是 Spark 中的一个子模块，主要用于操作结构化数据。它具有以下特点： 能够将 SQL 查询与 Spark 程序无缝混合，允许您使用 SQL 或 DataFrame API 对结构化数据进行查询； 支持多种开发语言； 支持多达上百种的外部数据源，包括 Hive，Avro，Parquet，ORC，JSON 和 JDBC 等； 支持 HiveQL 语法"
tags: []
draft: false
---
### 一、Spark SQL简介
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/aa9c2ee09782e5a0cb9fca084006b09b.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/2690a6e252c5371f6823da0d0c3094df.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/232cf30c269f14c4a0a3670c4e0d85c3.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/8b838026b41fe0aa8bfa11d8fc3ca02e.png#pic_center)

上面的描述可能并没有那么直观，下面的给出一个 IDEA 中代码编译的示例：

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/f28f20c1ae5ea1e1af30e09ecff6483e.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/7fe1e7351eaeade4b321f7f9d1b8319d.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/c2cce447ddedab1b145c9f764bdc3d98.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/333910f4f4fc2c47684341b0ecb67346.png#pic_center)
