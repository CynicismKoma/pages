---
title: "Spark 聚合函数Aggregations_spark agg函数"
pubDatetime: 2022-07-18T10:43:51
description: "一、简单聚合 1.1 数据准备 // 需要导入 spark sql 内置的函数包 import org . apache . spark . sql . functions . _ val spark = SparkSession . builder ( ) . appName ( 'aggregations' ) . master ( 'local[2]' ) . getOrCreate ( )"
tags: []
draft: false
---
### 一、简单聚合
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d527af6c969e2cd8238f81b3bb122b77.png#pic_center)
