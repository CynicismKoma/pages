---
title: "Spring/Spring Boot 整合 Mybatis + Phoenix_phoenix mybatis"
pubDatetime: 2022-07-18T10:55:28
description: "一、前言 使用 Spring+Mybatis 操作 Phoenix 和操作其他的关系型数据库（如 Mysql，Oracle）在配置上是基本相同的，下面会分别给出 Spring/Spring Boot 整合步骤 二、Spring + Mybatis + Phoenix 2.1 项目结构 2.2 主要依赖 除了 Spring 相关依赖外，还需要导入 phoenix-core 和对应的 Mybatis "
tags: []
draft: false
---
### 一、前言
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/395e419e37975721480fe71dee2da88a.png#pic_center)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/d24cd5de8387a671563c799939e585c3.png#pic_center)
