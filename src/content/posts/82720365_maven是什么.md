---
title: "maven是什么？"
pubDatetime: 2018-09-16T07:39:01.000Z
description: "文章浏览阅读165次。转载自https://www.cnblogs.com/whgk/p/7112560.html对我理解maven提供了很大的帮助，特转载以便以后查看。maven(一) maven到底是个啥玩意~　　　　　　我记得在搞懂maven之前看了几次重复的maven的教学视频。不知道是自己悟性太低还是怎么滴，就是搞不清楚，现在弄清楚了，基本上入门了。写该篇博文，就是为了帮助那些和我一样对"
tags: []
draft: false
---

## 转载自<https://www.cnblogs.com/whgk/p/7112560.html>  
  
## 对我理解maven提供了很大的帮助，特转载以便以后查看。
...
![](/assets/82720365_1.png)

三、maven的安装

这一步maven环境的配置，我觉得有必要安装一下，目的为了使用命令行创建maven项目，和使用命令行操作maven项目。这里不细讲，给出链接，跟安装jdk环境类似，[maven的安装教程和配置](<http://jingyan.baidu.com/article/4f7d5712a1306c1a21192746.html>)
...
![](/assets/82720365_7.png)

运行成功后

![](/assets/82720365_8.png)

在D:\java\maven\demo下就会生成一个simple的文件，该文件就是我们的maven java项目

![](/assets/82720365_9.png)
...
![](/assets/82720365_11.png)

在D:\java\maven\demo下就会生成一个myWebApp的文件 

![](/assets/82720365_12.png)
...
![](/assets/82720365_16.png)

2、创建一个简单项目（跳过骨架选择)

![](/assets/82720365_17.png)

3、设置项目参数，创建java项目

![](/assets/82720365_18.png)

![](/assets/82720365_19.png)

4、创建java项目结果

![](/assets/82720365_20.png)
...
![](/assets/82720365_21.png)

4、创建web项目结果

![](/assets/82720365_22.png)

5、可能报错1：pom.xml报错

![](/assets/82720365_23.png)

结果如下

![](/assets/82720365_24.png)

然后需要更新一下项目，就不报错了。

![](/assets/82720365_25.png)

6、报错2，编写jsp时报错

![](/assets/82720365_26.png)

错误信息为缺少serlvet-jar和jsp-jar包

![](/assets/82720365_27.png)

解决：使用pom.xml定位导入相应的jar包

![](/assets/82720365_28.png)

找到jsp-jar包，scope的作用是表示该jar包的作用范围，provided表示在编译和测试期有效，在运行期则无效。具体后面讲解pom.xml时会讲解到。 

![](/assets/82720365_29.png)

找到servle-jar包

![](/assets/82720365_30.png)

pom.xml中检查，修改

![](/assets/82720365_31.png)

修改完后，发现两个jar包都加载进来了，项目完好，不在报错了。

![](/assets/82720365_32.png)

6.3、创建maven项目

都一样，在项目参数那里修改即可

![](/assets/82720365_33.png)

结果

![](/assets/82720365_34.png)

maven项目一般没用，在开发中将一个项目拆分成多个项，就需要使用maven项目（pom项目）将其他子项目进行整合，下一章节讲解，很重要。很重要。

6.4、myeclipse maven操作

![](/assets/82720365_35.png)
...
![](/assets/82720365_38.png)

步骤二：输入关键字查询获得需要内容，确定需要版本

![](/assets/82720365_39.png)

步骤三、获得坐标

![](/assets/82720365_40.png)
...
![](/assets/82720365_41.png)

步骤二：获得坐标

![](/assets/82720365_42.png)

7.2、依赖(坐标)的常见配置

为了避免不知道说的哪些配置属性，看下面图就明白了，就是dependency下的属性配置，全部有9个，讲其中的7个。

![](/assets/82720365_43.png)
...
java web 5.0项目：![](/assets/82720365_50.png)

java web 6.0项目：![](/assets/82720365_51.png)

2、运行阶段(tomcat提供) 

![](/assets/82720365_52.png)
