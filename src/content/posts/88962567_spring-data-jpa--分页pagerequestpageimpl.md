...
pubDatetime: 2019-04-02T08:46:16.000Z
description: "文章浏览阅读1.5k次。本文介绍如何在SpringDataJPA中利用openid查询买家订单并实现分页显示。详细展示了Pageable接口的使用方法及PageRequest的最新用法，并通过PageImpl实现了分页结果的封装。"
tags: []
draft: false
---
