---
title: "echarts中datazoom相关配置"
pubDatetime: 2019-04-24T16:15:43.000Z
description: "文章浏览阅读572次。本文详细介绍了ECharts图表库中的数据缩放组件dataZoom的配置与使用方法，包括不同类型的dataZoom组件、控制的轴类型、数据窗口的设置、布局方式、触发缩放和平移的操作等，为用户提供丰富的图表交互体验。"
tags: []
draft: false
---
...
转载地址：http://blog.csdn.net/luanpeng825485697/article/details/76739026
