---
title: "Echarts饼状图属性设置大全"
pubDatetime: 2019-07-02T15:38:54.000Z
description: "文章浏览阅读8.4k次。本文详细解析了ECharts图表配置的各项参数，包括标题、图例、系列数据、提示框及颜色设置等内容，帮助读者理解如何定制化图表展示效果。"
tags: []
draft: false
---
1、标题设置
...
![](/assets/94447300_0.png)

radius: ['30%', '60%'], 的时候：

![](/assets/94447300_1.png)
